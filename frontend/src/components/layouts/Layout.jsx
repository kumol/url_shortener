    ...
    return(
        ...
        <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-xl border-gray-200">
            ...
            <div className="flex h-16 sm:h-18 items-center justify-between">
                ...
                { isLogedIn && user ? (<div className="flex items-center gap-4">
                    <Link to="/" className="px-5 py-2 text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg shadow-md hover:shadow-lg hover:brightness-105 transition">
                        Add New
                    </Link>
                    <Link onClick={()=> {
                ...
                <div className="flex items-center gap-4">
                    {
                        isLogedIn && user ? (
                            <Link to="/dashboard" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-indigo-700 hover:bg-indigo-50 rounded-lg transition">
                                Dashboard
                            </Link>
                        ) : null
                    }
                    ...
                    isLogedIn && user ? (
                        <button className="flex items-center gap-2 text-sm text-gray-700 hover:text-gray-900">
                            ...
                            <span className="font-medium hidden lg:inline">{user?.data?.name}</span>
                        </button>
                    ) : null
                    }
                </div>
